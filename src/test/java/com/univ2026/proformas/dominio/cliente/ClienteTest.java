...
class ClienteTest {
    ...
    void creaClienteConValoresValidos() {
        ...
        assertEquals(TipoCliente.PUBLICO, cliente.getTipo());
    ...
    void rechazaEmailMalFormado() {
        IllegalArgumentException error = assertThrows(
                ...
                () -> new Cliente(
                        "1100001239", "Luis", "", "", "correo-sin-arroba", TipoCliente.PUBLICO, Estado.ACTIVO));
